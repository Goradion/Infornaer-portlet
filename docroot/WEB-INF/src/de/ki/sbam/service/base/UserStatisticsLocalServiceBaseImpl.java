...
import de.ki.sbam.service.UserStatisticsLocalService;
...
/**
 * Provides the base implementation for the user statistics local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.ki.sbam.service.impl.UserStatisticsLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class UserStatisticsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UserStatisticsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.ki.sbam.service.UserStatisticsLocalServiceUtil} to access the user statistics local service.
	 */
	...
	public UserStatistics addUserStatistics(UserStatistics userStatistics) {
		...
		return userStatisticsPersistence.update(userStatistics);
	}
	...
	public UserStatistics createUserStatistics(long userId) {
		return userStatisticsPersistence.create(userId);
	}
	...
	public UserStatistics deleteUserStatistics(long userId)
		...
		return userStatisticsPersistence.remove(userId);
	}
	...
	public UserStatistics deleteUserStatistics(UserStatistics userStatistics) {
		return userStatisticsPersistence.remove(userStatistics);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UserStatistics.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return userStatisticsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return userStatisticsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public UserStatistics fetchUserStatistics(long userId) {
		return userStatisticsPersistence.fetchByPrimaryKey(userId);
	}
	...
	public UserStatistics getUserStatistics(long userId)
		throws PortalException {
		return userStatisticsPersistence.findByPrimaryKey(userId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return userStatisticsLocalService.deleteUserStatistics((UserStatistics)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return userStatisticsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<UserStatistics> getUserStatisticses(int start, int end) {
		return userStatisticsPersistence.findAll(start, end);
	}
	...
	public int getUserStatisticsesCount() {
		return userStatisticsPersistence.countAll();
	}
	 ...
	 */
	public UserStatisticsLocalService getUserStatisticsLocalService() {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.ki.sbam.model.UserStatistics",
			userStatisticsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"de.ki.sbam.model.UserStatistics");
	}
	...
	public String getOSGiServiceIdentifier() {
		return UserStatisticsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = userStatisticsPersistence.getDataSource();
	...
	private UserStatisticsLocalServiceClpInvoker _clpInvoker = new UserStatisticsLocalServiceClpInvoker();
}