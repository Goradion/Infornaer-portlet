 ...
 */
@ProviderType
public class HighscoreLocalServiceClp implements HighscoreLocalService {
	public HighscoreLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName5 = "addHighscore";

		_methodParameterTypes5 = new String[] { "de.ki.sbam.model.Highscore" };

		_methodName6 = "addHighscore";

		_methodParameterTypes6 = new String[] {
				"long", "com.liferay.portal.kernel.model.User"
			};

		_methodName7 = "createHighscore";

		_methodParameterTypes7 = new String[] { "long" };

		_methodName8 = "deleteHighscore";

		_methodParameterTypes8 = new String[] { "de.ki.sbam.model.Highscore" };

		_methodName9 = "deleteHighscore";
		...
		_methodName12 = "updateHighscore";

		_methodParameterTypes12 = new String[] { "de.ki.sbam.model.Highscore" };

		_methodName13 = "getHighscoresCount";
	...
	public de.ki.sbam.model.Highscore addHighscore(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName5,
					...
					new Object[] { ClpSerializer.translateInput(highscore) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
		...
		return (de.ki.sbam.model.Highscore)ClpSerializer.translateOutput(returnObj);
	}
	...
	public de.ki.sbam.model.Highscore addHighscore(long score,
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName6,
					...
					new Object[] { score, ClpSerializer.translateInput(user) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<de.ki.sbam.model.Highscore> getHighscores(int start,
		...
		return (java.util.List<de.ki.sbam.model.Highscore>)ClpSerializer.translateOutput(returnObj);
	}
