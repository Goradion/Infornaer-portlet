...
/**
 * Provides the local service interface for Highscore. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Alexander Mueller, Simon Bastian
 * @see HighscoreLocalServiceUtil
...
public interface HighscoreLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link HighscoreLocalServiceUtil} to access the highscore local service. Add custom service methods to {@link de.ki.sbam.service.impl.HighscoreLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
