 ...
 */
@ProviderType
public class UserQuestionLocalServiceClp implements UserQuestionLocalService {
	public UserQuestionLocalServiceClp(
		...
		_methodName5 = "addUserQuestion";

		_methodParameterTypes5 = new String[] { "de.ki.sbam.model.UserQuestion" };

		_methodName6 = "createUserQuestion";

		_methodParameterTypes6 = new String[] { "long" };

		_methodName7 = "deleteUserQuestion";

		_methodParameterTypes7 = new String[] { "de.ki.sbam.model.UserQuestion" };

		_methodName8 = "deleteUserQuestion";

		_methodParameterTypes8 = new String[] { "long" };

		_methodName9 = "fetchUserQuestion";

		_methodParameterTypes9 = new String[] { "long" };

		_methodName10 = "getUserQuestion";

		_methodParameterTypes10 = new String[] { "long" };

		_methodName11 = "updateUserQuestion";

		_methodParameterTypes11 = new String[] { "de.ki.sbam.model.UserQuestion" };

		_methodName12 = "getUserQuestionsCount";
		...
		_methodName18 = "getUserQuestions";
	...
	public de.ki.sbam.model.UserQuestion addUserQuestion(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName5,
					...
					new Object[] { ClpSerializer.translateInput(userQuestion) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
		...
		return (de.ki.sbam.model.UserQuestion)ClpSerializer.translateOutput(returnObj);
	}
	...
	public de.ki.sbam.model.UserQuestion createUserQuestion(long questionId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName6,
					_methodParameterTypes6, new Object[] { questionId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public de.ki.sbam.model.UserQuestion deleteUserQuestion(long questionId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName8,
					_methodParameterTypes8, new Object[] { questionId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<de.ki.sbam.model.UserQuestion> getUserQuestions(
		...
		return (java.util.List<de.ki.sbam.model.UserQuestion>)ClpSerializer.translateOutput(returnObj);
	}
