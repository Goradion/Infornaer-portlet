 ...
 */
@ProviderType
public class UserStatisticsLocalServiceClp implements UserStatisticsLocalService {
	public UserStatisticsLocalServiceClp(
		InvokableLocalService invokableLocalService) {
		_invokableLocalService = invokableLocalService;

		_methodName0 = "addPlayedGame";

		_methodParameterTypes0 = new String[] { "long" };

		_methodName1 = "addRightAnswer";

		_methodParameterTypes1 = new String[] { "long" };

		_methodName2 = "addUserStatistics";

		_methodParameterTypes2 = new String[] { "de.ki.sbam.model.UserStatistics" };

		_methodName3 = "addWonGame";

		_methodParameterTypes3 = new String[] { "long" };

		_methodName4 = "addWrongAnswer";

		_methodParameterTypes4 = new String[] { "long" };

		_methodName5 = "createUserStatistics";
		...
		_methodName7 = "deleteUserStatistics";

		_methodParameterTypes7 = new String[] { "long" };

		_methodName8 = "deleteUserStatistics";

		_methodParameterTypes8 = new String[] { "de.ki.sbam.model.UserStatistics" };
		...
		_methodName15 = "fetchUserStatistics";

		_methodParameterTypes15 = new String[] { "long" };

		_methodName16 = "findAll";
		...
		_methodName21 = "getUserStatistics";

		_methodParameterTypes21 = new String[] { "long" };

		_methodName22 = "getUserStatisticses";

		_methodParameterTypes22 = new String[] { "int", "int" };

		_methodName23 = "getUserStatisticsesCount";

		_methodParameterTypes23 = new String[] {  };

		_methodName25 = "updateUserStatistics";

		_methodParameterTypes25 = new String[] { "de.ki.sbam.model.UserStatistics" };
	}
	...
	public de.ki.sbam.model.UserStatistics addPlayedGame(long userId) {
		...
		return (de.ki.sbam.model.UserStatistics)ClpSerializer.translateOutput(returnObj);
	}
	...
	public de.ki.sbam.model.UserStatistics addUserStatistics(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					...
					new Object[] { ClpSerializer.translateInput(userStatistics) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<de.ki.sbam.model.UserStatistics> findAll() {
		...
		return (java.util.List<de.ki.sbam.model.UserStatistics>)ClpSerializer.translateOutput(returnObj);
	}
